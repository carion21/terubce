    ...
    <div class="about-container">
        <div class="about-grid">
            <div class="about-image-container">
                <img src="./assets/images/about.jpg" alt="À propos" class="about-image">
            </div>
            <div class="about-content">
                ...
                <div class="about-footer" style="display: none;">
                    <div class="image-gallery">
                        <img src="./assets/images/about1.jpg" alt="Gallery 1">
                        <img src="./assets/images/about2.jpg" class="img-middle" alt="Gallery 2">
                        <img src="./assets/images/about3.jpg" alt="Gallery 3">
                    </div>
                </div>
            </div>
        </div>
